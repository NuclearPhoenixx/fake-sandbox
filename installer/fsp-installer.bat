...
echo Visit https://github.com/NuclearPhoenixx/fake-sandbox/ for updates and fixes.
echo.
echo.
...
(
echo # This file was auto-generated by Fake Sandbox Processes (Version %@v%^) available on https://github.com/NuclearPhoenixx/fake-sandbox/
...
echo.
COLOR 0E
echo Would you like to enable the auto-updater to search and install updates regularly?
echo.
...
echo start /wait /MIN powershell -executionpolicy remotesigned -WindowStyle Hidden -Command "(New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/NuclearPhoenixx/fake-sandbox/master/updater/updater.bat', '%appdata%\FakeSandboxProcesses\updater_new.bat')"
...
echo # https://github.com/NuclearPhoenixx/fake-sandbox/issues
echo.
echo.
echo Press any key to exit...
pause>NUL
